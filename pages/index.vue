<template>
    <div>
        ...
        <DataTable :value="products">
            ...
            <Column :exportable="true" style="min-width:8rem">
                    <template #body="slotProps">
                        <Button icon="pi pi-pencil" class="p-button-rounded p-button-success mr-2" @click="editProduct(slotProps.data)"></Button>
                        <Button icon="pi pi-trash" class="p-button-rounded p-button-warning" @click="confirmDeleteProduct(slotProps.data)" ></Button>
                    </template>
                </Column>
        </DataTable>
        ...
        <Dialog v-model:visible="visibledialogDelete" :style="{width: '450px'}" header="Confirm Delete" :modal="true">
            ...
            <template #footer>
                <Button label="No" icon="pi pi-times" class="p-button-text" @click="visibledialogDelete = false"></Button>
